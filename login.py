...
class Interface:
    def __init__(self):
        super().__init__()
        """
        Initialize the ShoppingCartApp class.
        """
        self.root = tk.Tk()
    ...
    def show_product_menu(self):
        ...
        """
        product_menu = ProductMenu(self.root)  # Pass self.root or any necessary data
    ...
    def signup(self):
        ...
        if not Errors.is_valid_username(username):
            messagebox.showerror("Invalid Input",
                                 "Invalid Username. Username should be at least 3 characters long and contain only alphabetic characters.")
            return
